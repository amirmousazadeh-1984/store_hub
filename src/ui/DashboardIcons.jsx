...
function DashboardIcons({ setSelectedType }) {
        ...
        <div className={styles.categoryIcons}>
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "home" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "cars" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "electronics" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "computers" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "mobiles" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "books" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "clothing" ? styles.active : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.iconLink} ${
              currentType === "kitchenware" ? styles.active : ""
            }`}
